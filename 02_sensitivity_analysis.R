# Phase 2 - Sensitivity analysis for the primary model (NO2 -> respiratory disease)
#
# Three parts:
#   (A) main sensitivity grid: max lag, var df, lag df, time df, meteorology,
#       and whether the partial week W52/2025 is included or excluded
#   (B) Fourier seasonality vs natural-spline time
#   (C) winter interaction (a secondary check)
#
# Input : analysis_ready.csv (same folder)
# Output: sensitivity/dlnm_sensitivity_table.csv
#         sensitivity/dlnm_sensitivity_fourier.csv
#         sensitivity/dlnm_sensitivity_winter.csv
#         sensitivity/dlnm_sensitivity_summary.png
...
# Helper: fit one specification and return the cumulative RR at p75 vs reference
...
# Classify robustness against the primary point estimate (1.778, CI 1.052-3.006)
...
# Quick summary plot: points by max lag
...
# Winter-stratified cross-basis: cb_winter = cb * winter_flag
...
# Winter cumulative RR: refit a smaller winter-only model for a point estimate
