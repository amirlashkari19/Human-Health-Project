## ============================================================
##  P2 — Extended diagnostics (Day 7–8 Trello card)
##  Adds Cook's distance influence check + W52/2025 in-vs-out comparison
##  for the primary model (NO2 -> respiratory_disease).
## ============================================================
...
OUT  <- file.path(ROOT, "dlnm/diagnostics")
